...
#define FLAG_GOT_BRICK_PIECE            0x4A7
#define FLAG_HIDE_MANSION_OAK           0x4A8
#define FLAG_HIDE_MANSION_MEW           0x4A9
#define FLAG_DEFEATED_MANSION_OAK       0x4AA
#define FLAG_FOUGHT_MANSION_MEW         0x4AB
#define FLAG_HARD_MODE                  0x4AC
#define FLAG_GOT_FOSSIL_MON_GIFT        0x4AD // FRLG Legacy: Fuchsia fossil-mon gift
#define FLAG_JOHTO_CIRCUIT_CLEARED        0x4AE // Johto Isles all cleared
...
// FRLG Legacy: persistent cut-tree flags. A felled tree sets its flag so
// it never grows back; 0x4EA-0x4FF remain free.
#define FLAG_CUT_TREE_01                0x4BD
#define FLAG_CUT_TREE_02                0x4BE
#define FLAG_CUT_TREE_03                0x4BF
#define FLAG_CUT_TREE_04                0x4C0
#define FLAG_CUT_TREE_05                0x4C1
#define FLAG_CUT_TREE_06                0x4C2
#define FLAG_CUT_TREE_07                0x4C3
#define FLAG_CUT_TREE_08                0x4C4
#define FLAG_CUT_TREE_09                0x4C5
#define FLAG_CUT_TREE_10                0x4C6
#define FLAG_CUT_TREE_11                0x4C7
#define FLAG_CUT_TREE_12                0x4C8
#define FLAG_CUT_TREE_13                0x4C9
#define FLAG_CUT_TREE_14                0x4CA
#define FLAG_CUT_TREE_15                0x4CB
#define FLAG_CUT_TREE_16                0x4CC
#define FLAG_CUT_TREE_17                0x4CD
#define FLAG_CUT_TREE_18                0x4CE
#define FLAG_CUT_TREE_19                0x4CF
#define FLAG_CUT_TREE_20                0x4D0
#define FLAG_CUT_TREE_21                0x4D1
#define FLAG_CUT_TREE_22                0x4D2
#define FLAG_CUT_TREE_23                0x4D3
#define FLAG_CUT_TREE_24                0x4D4
#define FLAG_CUT_TREE_25                0x4D5
#define FLAG_CUT_TREE_26                0x4D6
#define FLAG_CUT_TREE_27                0x4D7
#define FLAG_CUT_TREE_28                0x4D8
#define FLAG_CUT_TREE_29                0x4D9
#define FLAG_CUT_TREE_30                0x4DA
#define FLAG_CUT_TREE_31                0x4DB
#define FLAG_CUT_TREE_32                0x4DC
#define FLAG_CUT_TREE_33                0x4DD
#define FLAG_CUT_TREE_34                0x4DE
#define FLAG_CUT_TREE_35                0x4DF
#define FLAG_CUT_TREE_36                0x4E0
#define FLAG_CUT_TREE_37                0x4E1
#define FLAG_CUT_TREE_38                0x4E2
#define FLAG_CUT_TREE_39                0x4E3
#define FLAG_CUT_TREE_40                0x4E4
#define FLAG_CUT_TREE_41                0x4E5
#define FLAG_CUT_TREE_42                0x4E6
...
#define FLAG_BEAT_HOENN_FLANNERY    (TRAINER_FLAGS_START + TRAINER_HOENN_FLANNERY)
#define FLAG_BEAT_HOENN_WALLACE    (TRAINER_FLAGS_START + TRAINER_HOENN_WALLACE)
#define FLAG_BEAT_HOENN_ROXANNE    (TRAINER_FLAGS_START + TRAINER_HOENN_ROXANNE)
#define FLAG_BEAT_HOENN_BRAWLY    (TRAINER_FLAGS_START + TRAINER_HOENN_BRAWLY)
#define FLAG_BEAT_HOENN_TATE_LIZA    (TRAINER_FLAGS_START + TRAINER_HOENN_TATE_LIZA)
#define FLAG_BEAT_HOENN_NORMAN    (TRAINER_FLAGS_START + TRAINER_HOENN_NORMAN)
#define FLAG_BEAT_HOENN_WATTSON    (TRAINER_FLAGS_START + TRAINER_HOENN_WATTSON)
#define FLAG_BEAT_HOENN_WINONA    (TRAINER_FLAGS_START + TRAINER_HOENN_WINONA)
#define FLAG_BEAT_JOHTO_FALKNER    (TRAINER_FLAGS_START + TRAINER_JOHTO_FALKNER)
#define FLAG_BEAT_JOHTO_BUGSY    (TRAINER_FLAGS_START + TRAINER_JOHTO_BUGSY)
#define FLAG_BEAT_JOHTO_WHITNEY    (TRAINER_FLAGS_START + TRAINER_JOHTO_WHITNEY)
#define FLAG_BEAT_JOHTO_MORTY    (TRAINER_FLAGS_START + TRAINER_JOHTO_MORTY)
#define FLAG_BEAT_JOHTO_CHUCK    (TRAINER_FLAGS_START + TRAINER_JOHTO_CHUCK)
#define FLAG_BEAT_JOHTO_JASMINE    (TRAINER_FLAGS_START + TRAINER_JOHTO_JASMINE)
#define FLAG_BEAT_JOHTO_PRYCE    (TRAINER_FLAGS_START + TRAINER_JOHTO_PRYCE)
#define FLAG_BEAT_JOHTO_CLAIR    (TRAINER_FLAGS_START + TRAINER_JOHTO_CLAIR)
